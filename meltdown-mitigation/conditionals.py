...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    check_temperature = temperature < 800
    check_neutrons_emitted = neutrons_emitted > 500
    check_product_temp_neutrons = (temperature * neutrons_emitted) < 500000

    return check_temperature and check_neutrons_emitted and check_product_temp_neutrons
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    conditional =  temperature * neutrons_produced_per_second
    percent = (conditional * 100) / threshold
