...
class PhoneNumber:
    ...
    def __init__(self, number):
        ...
        if ((check_number[3] == '0' and len(check_number) ==10) or
            (check_number[4] == '0' and len(check_number) ==11)):
            raise ValueError("exchange code cannot start with zero")
        # if a phone number has an exchange code that starts with 1.
        if ((check_number[3] == '1' and len(check_number) == 10) or
            (check_number[4] == '1' and len(check_number) ==11)):
            raise ValueError("exchange code cannot start with one")
        # if a phone number has an area code that starts with 0.
        if ((check_number[0] == '0' and len(check_number) == 10) or
            (check_number[1] == '0' and len(check_number) ==11)):
            raise ValueError("area code cannot start with zero")
        # if a phone number has an area code that starts with 1.
        if ((check_number[0] == '1' and len(check_number) == 10) or
            (check_number[1] == '1' and len(check_number) ==11)):
