""" Gerenciamento de filas para montanha russa """

def add_me_to_the_queue(express_queue: list, normal_queue: list,
                        ticket_type: int, person_name: str) -> list:
    """""
    ...
    if ticket_type == 0:
        ...
        update_list = normal_queue
    else:
        express_queue.append(person_name)
        update_list = express_queue
    return update_list
...
def sorted_names(queue: list) -> list:
    ...
    """
    alphabetic_queue = queue[:]
    alphabetic_queue.sort()
